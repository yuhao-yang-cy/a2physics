...
the diagram below illustrates the production of X-ray in a \emph{X-ray tube}\index{X-ray tube}
...
so we need to study properties of \emph{X-ray spectrum} as it is produced in X-ray tubes\index{X-ray!spectrum}
...
each slice can be divided into a grid of many units, called \keypoint{voxels}\index{voxel}
