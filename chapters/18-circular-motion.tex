...
\subsubsection{uniform circular motion}\index{uniform circular motion}
...
or equivalently, if $\fnet \perp v$, then this net force provides centripetal force for circular motion
...
\example{A rock is able to orbit around the earth near the surface of the earth. Given that radius of the earth $R=6400$ km and air resistance is ignored, (a) what is its orbital speed? (b) What is the orbital period?}
