...
\example{For the circuit shown, find the p.d. across each of the capacitor.}
...
\example{Four identical capacitors are arranged as shown. Given that each capacitor can withstand a maximum p.d. of 12 V, what is the maximum p.d. that can safely be applied between the terminals?}
