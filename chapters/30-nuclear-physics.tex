...
\begin{ilight}
	energy needed to separate the nucleons in a nucleus to infinity, or equivalently, energy released when free individual nucleons combine to form a nucleus, is called the \keypoint{nuclear binding energy} ($E_B$)
\end{ilight}
...
\question{Why is the rest mass of proton slightly larger than the unified atomic mass unit?}
...
\begin{ilight}
	the process of \emph{random} and \emph{spontaneous} emission of $\alpha$-, $\beta$-, and $\gamma$-radiation from unstable nuclei is called \keypoint{radioactive decay}
\end{ilight}
...
\cmt to describe the rate of decay, we introduce the notion of \keypoint{activity}
...
\begin{wrapfigure}{r}{0.45\textwidth}
	...
	\foreach \x in {0,0.6,1.1,1.6,2.2,2.7,3.1,3.6,4.2}{
